...
public class Api {
	...
	public Api(final String sistema) {
		log = new Log(sistema);
		try {
	...
	public void registrarEvento(final String usuario, final String evento) {
	...
	private File criarArquivo(final String sistema) throws IOException {
